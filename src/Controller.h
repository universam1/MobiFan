...
// Manual: levels 0..5 as fixed power steps.
// Auto: levels 1..5 select a ramp; power runs continuously from the minimum
...
public:
  ...
  float computePowerPercent(float tempC, bool tempValid) const;
